...
BotSever1 = 1204647300870311986  # ไอดี เซิฟเวอร์ดิสคอส[span_1](start_span)[span_1](end_span)
...
async def on_ready():
    ...
    # รอให้ระบบพร้อมสักครู่ก่อนดึงบอทเข้าห้องเสียง
    ...
    if guild:
        ...
        if vc:
            try:
                # คำสั่งเชื่อมต่อเข้าห้องเสียงจริงแบบเสถียร
...
if __name__ == "__main__":
    ...
    # รันบอทโดยดึง Token จาก Environment Variables ของ Render เพื่อความปลอดภัย
